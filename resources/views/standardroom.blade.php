...
@endsection
@section('header')
<header id="header" class="infoHeader" style="background: url('{{asset('../resources/img/r1.jpg')}}') no-repeat center top / cover">
    <div class="nav">
        <div class="container">
            <div class="top">
                <div class="logo">
            ...
            <div class="hotelInfo">
                ...
                <div class="about">
                    <div class="mainInfo">
                        ...
                        <p>
                            Площа номера: номер - 30 кв. м, балкон - 7 кв. м;<br>
                ...
                <div class="priceAndBooking">
                    <div class="price">
                        ...
                        <p>
                            Land view: 1500 грн/день;<br>
                            Garden view: 2000 грн/день;<br>
                            Pool view: 2200 грн/день;<br>
                            Sea view : 2500 грн/день<br>
                        </p>
                    </div>
                    <div class="booking">
                        <div class="stars">

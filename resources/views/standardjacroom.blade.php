...
@endsection
@section('header')
    <header id="header" class="infoHeader" style="background: url('{{asset('../resources/img/r2.jpg')}}') no-repeat center top / cover">
        <div class="nav">
            <div class="container">
                <div class="top">
                    <div class="logo">
            ...
            <div class="hotelInfo">
                ...
                <div class="about">
                    <div class="mainInfo">
                        ...
                        <p>
                            Площа номера: номер - 40 кв. м, балкон - 7 кв. м;<br>
                            Планування: відкритого типу;<br>
                            Розташування: 1, 2 або 3 поверх;
                            Вид: на море / на басейни / на сад / на пейзаж;<br>
                            Максимальне розміщення: 3 дорослих / 2 дорослих + 1 дитина.<br>
                        </p>
                    </div>
                ...
                <div class="priceAndBooking">
                    <div class="price">
                        ...
                        <p>
                            Land view: 2000 грн/день;<br>
                            Garden view: 2300 грн/день;<br>
                            Pool view: 2500 грн/день;<br>
                            Sea view : 3000 грн/день<br>
                        </p>
                    </div>
                    <div class="booking">
                        <div class="stars">

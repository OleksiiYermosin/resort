...
@endsection
@section('header')
    <header id="header" class="infoHeader" style="background: url('{{asset('../resources/img/r3.jpg')}}') no-repeat center top / cover">
        <div class="nav">
            <div class="container">
                <div class="top">
                    <div class="logo">
            ...
            <div class="hotelInfo">
                ...
                <div class="about">
                    <div class="mainInfo">
                        ...
                        <p>
                            Площа номера: номер - 50 кв. м, балкон - 10 кв. м;<br>
                            Планування: відкритого типу;<br>
                            Розташування: 2 або 3 поверх;
                ...
                <div class="priceAndBooking">
                    <div class="price">
                        ...
                        <p>
                            Land view: 4000 грн/день;<br>
                            Garden view: 4000 грн/день;<br>
                            Pool view: 4000 грн/день;<br>
                            Sea view : 4000 грн/день<br>
                        </p>
                    </div>
                    <div class="booking">
                        <div class="stars">

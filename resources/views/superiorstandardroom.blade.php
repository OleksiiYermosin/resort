...
@endsection
@section('header')
    <header id="header" class="infoHeader" style="background: url('{{asset('public/img/r3.jpg')}}') no-repeat center top / cover">
        <div class="nav">
            <div class="container">
                <div class="top">
                    <div class="logo">
                ...
                <div class="priceAndBooking">
                    <div class="price">
                        ...
                        <p>
                            ...
                            Garden view: 4200 грн/день;<br>
                            Pool view: 4300 грн/день;<br>

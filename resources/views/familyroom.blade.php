...
@endsection
@section('header')
    <header id="header" class="infoHeader" style="background: url('{{asset('../resources/img/r4.jpg')}}') no-repeat center top / cover">
        <div class="nav">
            <div class="container">
                <div class="top">
                    <div class="logo">
            ...
            <div class="hotelInfo">
                ...
                <div class="about">
                    <div class="mainInfo">
                        ...
                        <p>
                            Площа номера: номер - 70 кв. м, балкон - 10 кв. м;<br>
                            Планування: відкритого типу;<br>
                            Розташування: 2 або 3 поверх;
                            Вид: на море / на басейни / на сад / на пейзаж;<br>
                            Максимальне розміщення: 4 дорослих / 2 дорослих + 4 дитини.<br>
                        </p>
                    </div>
                ...
                <div class="priceAndBooking">
                    <div class="price">
                        ...
                        <p>
                            Land view: 3500 грн/день;<br>
                            Garden view: 3700 грн/день;<br>
                            Pool view: 400 грн/день;<br>
                            Sea view : 4500 грн/день<br>
                        </p>
                    </div>
                    <div class="booking">
                        <div class="stars">
